...
// ho aggiunto 2 var cond
#define CV_FULL   0      /* produttori in attesa di spazio   */
#define CV_EMPTY  1      /* consumatore in attesa di dati    */
...
typedef struct {
    ...
    int ready_parts;          /*  0 = nessuna metà pronta
                            1 = prima o seconda metà pronta
                            2 = entrambe pronte               */
