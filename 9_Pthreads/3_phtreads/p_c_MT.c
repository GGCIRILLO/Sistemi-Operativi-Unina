...
int main(){
     ...
     // Il programma è multi-thread, non multi-processo: 
     // tutti i thread vivono nello stesso spazio di indirizzamento, 
     // quindi qualsiasi blocco allocato con malloc è già visibile a tutti.
